...
namespace Zenject
{
    ...
    {
        /// <summary>
        /// enable debug loading (for per-scene edit mode testing)
        /// </summary>
        public static bool SuppressFatalErrors { get; set; }
        ...
        IEnumerable<DiContainer> GetParentContainers()
        {
            ...
            if (!parentContainers.Any() && !SuppressFatalErrors)
            {
        ...
        public void Install()
        {
            ...
            if (SuppressFatalErrors && parents.IsEmpty()) {
                return;
            }
        ...
        public void Resolve()
        {
            if (_container == null && SuppressFatalErrors) return;
